   ...
   a_scale_(1.0)
{
   ...
   odom_sub_ = nh_.subscribe("xolo1/odom", 1000, chatterCallback);
   odom_sub_ = nh_.subscribe("xolo2/odom", 1000, chatterCallback);
   odom_sub_ = nh_.subscribe("xolo3/odom", 1000, chatterCallback);
